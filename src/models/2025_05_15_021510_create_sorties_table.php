...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sorties', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('categorie_sortie_id')->nullable();

            $table->dateTime('date_heure_mouvement');
            $table->decimal('montant', 10, 2);
            $table->string('beneficiaire_motif');
            ...
            $table->foreign('categorie_sortie_id')->references('id')->on('categorie_sorties')->onDelete('set null');
            ...
            $table->index('categorie_sortie_id');
